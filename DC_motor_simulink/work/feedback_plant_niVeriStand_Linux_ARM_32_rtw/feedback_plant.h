...
typedef struct {
  ...
  real_T radtodeg;                     /* '<S1>/rad to deg' */
  real_T Sum;                          /* '<S3>/Sum' */
  real_T Abs;                          /* '<S2>/Abs' */
  real_T ErrorPositionDegRange0to360;  /* '<Root>/Sum' */
  real_T Integrator2;                  /* '<S1>/Integrator2' */
  real_T Kt;                           /* '<S1>/Kt' */
  real_T Integrator;                   /* '<S1>/Integrator' */
  real_T damping;                      /* '<S1>/damping' */
  real_T Add;                          /* '<S1>/Add' */
  real_T Resistance;                   /* '<S1>/Resistance' */
  real_T Ke;                           /* '<S1>/Ke' */
  real_T Add1;                         /* '<S1>/Add1' */
  real_T Inductance;                   /* '<S1>/Inductance' */
...
typedef struct {
  ...
  real_T ErrorDeg;                     /* '<Root>/Error[Deg]' */
 ...
 * '<S3>'   : 'feedback_plant/Reference/Repeating Sequence'
 */
