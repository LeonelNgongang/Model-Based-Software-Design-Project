 ...
 * C source code generated on : Tue Jul 18 01:28:12 2017
 *
...
void feedback_plant_output(void)
{
  ...
  /* Sum: '<Root>/Sum' */
  feedback_plant_B.ErrorPositionDegRange0to360 = feedback_plant_B.Abs -
    feedback_plant_B.radtodeg;

  /* Outport: '<Root>/Error[Deg]' */
  feedback_plant_Y.ErrorDeg = feedback_plant_B.ErrorPositionDegRange0to360;
 ...
 * Source generated on : Tue Jul 18 01:28:08 2017
 *========================================================================*/
...
void SetExternalOutputs(double* data, int_T* TaskSampleHit)
{
  ...
  if (TaskSampleHit[0]) {              // sample and hold
    /* rtOUT->ErrorDeg has width [1, 1] type real_T -> 0 */
    ni_extout[index++] = NIRT_GetValueByDataType(&(rtOUT->ErrorDeg), 0, 0, 0);
  } else {
    index += 1;
  }
...
int32_t NI_InitExternalOutputs()
{
  ...
  /* rtOUT->ErrorDeg has width 1 -> [1, 1] type 0 -> 0 */
  ni_extout[index++] = NIRT_GetValueByDataType(&(rtOUT->ErrorDeg), 0, 0, 0);
  UNUSED_PARAMETER(count);
  return NI_OK;
}
...
static NI_Signal NI_SigList[] DataSection(".NIVS.siglist") =
{
  ...
  { 1, "feedback_plant/DC Motor/Integrator1", 0, "", offsetof(B_feedback_plant_T,
    Integrator1) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 2, "feedback_plant/DC Motor/rad to deg", 0, "", offsetof(B_feedback_plant_T,
    radtodeg) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },
  ...
  { 5, "feedback_plant/Sum", 0, "ErrorPosition [Deg]Range: 0 to 360", offsetof
    (B_feedback_plant_T, ErrorPositionDegRange0to360) + (0*sizeof(real_T)),
    BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 6, "feedback_plant/DC Motor/Integrator2", 0, "", offsetof(B_feedback_plant_T,
    Integrator2) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 7, "feedback_plant/DC Motor/Kt", 0, "", offsetof(B_feedback_plant_T, Kt) +
    (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 8, "feedback_plant/DC Motor/Integrator", 0, "", offsetof(B_feedback_plant_T,
    Integrator) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 9, "feedback_plant/DC Motor/damping", 0, "", offsetof(B_feedback_plant_T,
    damping) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 10, "feedback_plant/DC Motor/Add", 0, "", offsetof(B_feedback_plant_T, Add)
    + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 11, "feedback_plant/DC Motor/Resistance", 0, "", offsetof(B_feedback_plant_T,
    Resistance) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 12, "feedback_plant/DC Motor/Ke", 0, "", offsetof(B_feedback_plant_T, Ke) +
    (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 13, "feedback_plant/DC Motor/Add1", 0, "", offsetof(B_feedback_plant_T, Add1)
    + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 14, "feedback_plant/DC Motor/Inductance", 0, "", offsetof(B_feedback_plant_T,
    Inductance) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },

  { 15, "feedback_plant/DC Motor/Inertia", 0, "", offsetof(B_feedback_plant_T,
    Inertia) + (0*sizeof(real_T)), BLOCKIO_SIG, 0, 1, 2, 0, 0 },
...
static const char* NI_CompiledModelName DataSection(".NIVS.compiledmodelname") =
  "feedback_plant";
static const char* NI_CompiledModelVersion = "1.29";
static const char* NI_CompiledModelDateTime = "Tue Jul 18 01:28:08 2017";
