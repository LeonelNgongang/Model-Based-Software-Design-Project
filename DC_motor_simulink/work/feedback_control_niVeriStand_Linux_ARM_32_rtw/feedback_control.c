 ...
 * C source code generated on : Tue Jul 18 01:33:34 2017
 *
...
static void feedback_control_output(void)
{
   ...
   */
  u0 = 0.012 * feedback_control_U.ErrorDeg;

  /* Saturate: '<Root>/Saturation' */
  if (u0 > 1.0) {
    /* Outport: '<Root>/Command [V]' */
    feedback_control_Y.CommandV = 1.0;
  } else if (u0 < -1.0) {
    /* Outport: '<Root>/Command [V]' */
    feedback_control_Y.CommandV = -1.0;
  } else {
    /* Outport: '<Root>/Command [V]' */
    feedback_control_Y.CommandV = u0;
  }
...
RT_MODEL_feedback_control_T *feedback_control(void)
{
  ...
  feedback_control_U.ErrorDeg = 0.0;

  /* external outputs */
  feedback_control_M->ModelData.outputs = (&feedback_control_Y);
  feedback_control_Y.CommandV = 0.0;
 ...
 * Source generated on : Tue Jul 18 01:33:33 2017
 *========================================================================*/
...
void SetExternalInputs(double* data, int_T* TaskSampleHit)
{
  ...
  if (TaskSampleHit[0]) {              // sample and hold
    /* rtIN->ErrorDeg Type real_T -> 0 Width [1, 1] */
    NIRT_SetValueByDataType(&rtIN->ErrorDeg, 0, data[index++], 0, 0);
...
void SetExternalOutputs(double* data, int_T* TaskSampleHit)
{
  ...
  ExtY_feedback_control_T* rtOUT = (ExtY_feedback_control_T*)
    S->ModelData.outputs;
  if (TaskSampleHit[0]) {              // sample and hold
    /* rtOUT->CommandV has width [1, 1] type real_T -> 0 */
    ni_extout[index++] = NIRT_GetValueByDataType(&(rtOUT->CommandV), 0, 0, 0);
  } else {
    index += 1;
  }
...
int32_t NI_InitExternalOutputs()
{
  ...
  /* rtOUT->CommandV has width 1 -> [1, 1] type 0 -> 0 */
  ni_extout[index++] = NIRT_GetValueByDataType(&(rtOUT->CommandV), 0, 0, 0);
  UNUSED_PARAMETER(count);
  return NI_OK;
}
...
{
  { 0, "feedback_control/Error [Deg]", 0, "", offsetof(ExtU_feedback_control_T,
    ErrorDeg) + (0*sizeof(real_T)), EXTIO_SIG, 0, 1, 2, 0, 0 },
...
static const char* NI_CompiledModelName DataSection(".NIVS.compiledmodelname") =
  "feedback_control";
static const char* NI_CompiledModelVersion = "1.43";
static const char* NI_CompiledModelDateTime = "Tue Jul 18 01:33:33 2017";
