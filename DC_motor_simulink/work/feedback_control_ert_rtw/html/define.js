function CodeDefine() { 
this.def = new Array();
this.def["feedback_control_M_"] = {file: "ert_main_c.html",line:25,type:"var"};
this.def["feedback_control_M"] = {file: "ert_main_c.html",line:26,type:"var"};
this.def["feedback_control_U_ErrorDeg"] = {file: "ert_main_c.html",line:30,type:"var"};
this.def["feedback_control_Y_CommandV"] = {file: "ert_main_c.html",line:33,type:"var"};
this.def["rt_OneStep"] = {file: "ert_main_c.html",line:47,type:"fcn"};
this.def["main"] = {file: "ert_main_c.html",line:85,type:"fcn"};
this.def["feedback_control_step"] = {file: "feedback_control_c.html",line:53,type:"fcn"};
this.def["feedback_control_initialize"] = {file: "feedback_control_c.html",line:81,type:"fcn"};
this.def["feedback_control_terminate"] = {file: "feedback_control_c.html",line:99,type:"fcn"};
this.def["RT_MODEL_feedback_control_T"] = {file: "feedback_control_h.html",line:38,type:"type"};
